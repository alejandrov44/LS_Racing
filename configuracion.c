...
void PanelConfiguracion(General general, Coche * coche){
    ...
    //Fotos allegro
    ALLEGRO_BITMAP * boxes = al_load_bitmap("../assets/boxes.png");
    ALLEGRO_BITMAP * cotxe = al_load_bitmap("../assets/cotxe.png");
    ALLEGRO_BITMAP * gasolina = al_load_bitmap("../assets/gasolina.png");
    ALLEGRO_BITMAP * motor = al_load_bitmap("../assets/motor.png");
    ALLEGRO_BITMAP * neumaticos = al_load_bitmap("../assets/neumaticos.png");
